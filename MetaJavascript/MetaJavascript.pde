// META_JAVASCRIPT Version Alpha 1.2
...
// Se actualizó ventana de configuración
// Se agrega instrucción abrir URL hipervínculo
// Se agrega instrucción leerargumento
// Se agrega soporte para instrucciones Arduino
// Se agrega soporte para instrucciones IotController
...
//println(texto[1]);
  ...
  void guardapde(int modo){
      ...
      //lib[0]=lib[0]+"// Generated with Meta_Javascript Alpha 1.2\n// https://github.com/hiteclab/Meta_Javascript/releases\n";
